...
import {favoriteCourseData} from '@/constants/data'
  ...
  export function FavoriteCourse() {
    ...
    return (
        ...
        <h1 className='w-[90%] mx-auto  text-[20px] text-[#FFFFFF] font-semibold leading-[22px]'>Courses from your favourite organizations</h1>
   ...
   >
           {favoriteCourseData.map((data, index) => (
             <FavoriteCourseCard key={index} title={data.coursetitle}

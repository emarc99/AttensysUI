...
const Createevents = () => {
  ...
  const handlerouting = (event: React.MouseEvent<HTMLButtonElement | HTMLDivElement>) => {
  ...
  return (
    <div className={`bg-[url('/hero_asset.png')] h-[389px] w-[90%] mx-auto rounded-xl flex items-center`}>
        <div className='w-[80%] mx-auto h-[250px]'>
            <h1 className='text-[30.19px] font-bold text-[#FFFFFF] leading-[39px] w-[450px]'>Create <span className='bg-gradient-to-r from-[#9B51E0] via-[#9B51E0] to-[#4A90E2] text-transparent bg-clip-text'>events,</span><br/> 
                send out invitations, 
                and effortlessly track attendance</h1>
            <p className='text-[17px] text-[#FFFFFF] leading-[22px] font-light py-4 w-[571px]'>Simplifying certificate issuance, attendance tracking, and online course 

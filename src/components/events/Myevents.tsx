...
const Myevents = (props: any) => {
  ...
  const [existingeventStat, setexistingeventStat] = useAtom(existingeventCreationAtom,)
...
const boiler = () => {
    return  <>
    <div className="flex justify-between w-[75%] mx-auto h-[100px] items-center">
    <h1 className="text-[20px] leading-[39px] font-bold text-[#FFFFFF]">
      My Events
    </h1>
    <div className="flex w-[420px] clg:w-[400px] lclg:w-[350px] space-x-8 items-center">
      <div
  ...
  const renderContent = () => {
    switch (props.section) {
      case 'createevent':
        ...
        return <>
            <div className="h-full w-[70%] mx-auto flex justify-between py-16">
                    <div className="w-[60%]">
                        <div className="flex space-x-4 items-center">
                             <div className="w-[6px] h-[69px] bg-[#9B51E0]"></div>
                             <div>
                                <h1 className="text-[#FFFFFF] font-bold text-[24px] leading-[39px]">Create an event</h1>
                                <p className="text-[16px] text-[#FFFFFF] font-light leading-[22px]">Tell us more about your event</p>
                             </div>
                        </div>
                        ...
                        <div className="w-full max-w-lg px-4 mt-4">
                                <Field>
                                    <Label className="text-sm/6 font-medium text-white">Start time</Label>
                                    <Input
                                     type="time"
                                    className={clsx(
                        ...
                        <div className="w-full max-w-lg px-4 mt-4">
                            <Field>
                                <Label className="text-sm/6 font-medium text-white">End Time</Label>
                                <Input
                                 type="time"
                                className={clsx(
                                    'mt-1 block w-full rounded-lg border-none bg-white/5 py-1.5 px-3 text-sm/6 text-white',
                        ...
                        <div className="w-full max-w-lg px-4 mt-4">
                            <Field>
                                <Label className="text-sm/6 font-medium text-white">Add Event Location</Label>
                                <Description className="text-sm/6 text-white/50">Choose Onsite Location or Virtual link </Description>
                                <textarea
                                className={clsx(
                        ...
                        <div className="w-full max-w-lg px-4 mt-4">
                            <Field>
                                <Label className="text-sm/6 font-medium text-white">Add Description</Label>
                                <Description className="text-sm/6 text-white/50">A brief description of the event </Description>
                                <textarea
                                className={clsx(
                    ...
                    <div className="w-[50%] flex flex-col justify-center items-center space-y-8">
                        <h1 className="w-[422px] text-[24px] font-bold leading-[39px] text-[#FFFFFF]">Add an event design</h1>
                        ...
                        <Button onClick={handleCreateEventButton} className="hidden lg:flex rounded-lg bg-[#4A90E2] py-2 px-4 lg:h-[50px] items-center lg:w-[422px] text-sm text-white data-[hover]:bg-sky-500 data-[active]:bg-sky-700 justify-center">                       
                          Create an Event
                    </Button>
                    </div>
            </div>
      ...
      case 'createdevent':
        ...
        return <>
        {boiler()};
        {!Regstat && !existingeventStat &&  (<div className="h-[400px] w-[70%] flex flex-col mx-auto items-center justify-center mt-5">
          ...
          <p className="mb-10 text-[16px] text-[#FFFFFF] leading-[22px] font-light w-[320px] text-center">
            ...
            <span className="font-bold">How about we get you started?</span>
          </p>
          <Button onClick={handleCreateEventClick} className="hidden lg:flex rounded-lg bg-[#4A90E2] py-2 px-4 lg:h-[50px] items-center lg:w-[170px] text-sm text-white data-[hover]:bg-sky-500 data-[active]:bg-sky-700">
  ...
  return (
    <div style={{ height }} className="w-[100%] bg-event-gradient my-8">
      {renderContent()}
    </div>
  )
}

  ...
  return (
    <div className='h-[261px] w-[90%] mx-auto flex justify-between items-center rounded-xl'>
        ...
        <div className={`bg-[url('/dashbordbg.svg')] h-full w-[78%] rounded-xl bg-cover px-10 space-y-20 flex flex-col justify-center`}>
            ...
            <Button onClick={handleCreateMeeting} className="h-[49px] w-[206px] flex items-center space-x-2 justify-center bg-[#FFFFFF] rounded-xl">
                <FiLink className='text-[#9747FF] h-[17px] w-[17px]' />
                <h1 className='text-[#2D3A4B] text-[14px] leading-[19px] font-bold'>Create Meeting</h1>
            </Button>
            </div>
            ...
            <div className='space-y-1'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex space-x-1 items-center'>
                    <h1 className='text-[#FFFFFF] text-[17px] leading-[25px] font-black'>Edit bootcamp page</h1>

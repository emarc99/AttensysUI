...
<Dialog open={open} onClose={setOpen} className="relative z-10">
  ...
  <div className="fixed inset-0 z-10 overflow-y-auto">
    <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
      <DialogPanel
        className="relative h-[800px] w-[988px] transform overflow-hidden rounded-lg bg-white text-left shadow-xl sm:my-8"
      >
        ...
        <h1 className='text-[22px] font-semibold leading-[31px] text-[#5801A9]'>Course Outline upload</h1>
          <Image src={cancel} alt='cancel' onClick={() => {setOpen(false); setAddclass(false);}} />
                ...
                <h1 className='text-[16px] text-[#2D3A4B] font-light leading-[23px]'>Topic: </h1>
                    ...
                    <div className='mt-6'>
                            ...
                            <div className='flex space-x-16'>
                                ...
                                <h1 className='w-[254px] text-[14px] font-light text-[#2D3A4B] leading-[21px]'>Upload your Recorded class here for your students to watch later</h1>
            ...
            <div className='flex justify-end my-5 px-16'>
                                        <div  onClick={() => {setOpen(false); setAddclass(false);}} className='h-[47px] w-[342px] rounded-xl bg-[#9B51E0] flex items-center justify-center cursor-pointer'>

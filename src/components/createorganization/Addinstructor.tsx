  ...
  return (
    <div className='h-[500px] w-full flex flex-col items-center space-y-8 py-3'>
            <div className='mx-auto pt-12'>
                        <h1 className='text-[16px] text-[#2D3A4B] font-light leading-[23px]'>Use commas (,) to seperate instructor emails</h1>
            ...
            <div className='mx-auto'>
                        <h1 className='text-[16px] text-[#2D3A4B] font-light leading-[23px]'>Use commas (,) to seperate wallet addresses</h1>
                        <div className='flex space-x-3 items-center'>
                                <div className='w-[590px] h-[60px] border-[2px] rounded-2xl mt-5'>

...
<div className='w-[60%] h-[430px] flex flex-col items-center justify-center space-y-4'>
    <h1 className='text-[20px] text-[#2D3A4B] font-light leading-[23px]'>Connected Address : {trimAddress(wallet?.selectedAddress)} </h1>
                    <TrueFocus 
        ...
        <Button onClick={()=>{handlerouting("admin-info")}} className="w-[342px] h-[47px] flex justify-center items-center text-[#FFFFFF] text-[14px] font-bold leading-[16px] bg-[#9B51E0] rounded-xl">Almost there</Button>

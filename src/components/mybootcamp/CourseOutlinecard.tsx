...
const CourseOutlinecard = (props: any) => {
  return (
    <div className="py-6 flex flex-col space-x-0 space-y-2 items-start justify-start md:flex-row md:space-y-0 md:space-x-8 md:items-center md:justify-between h-auto md:h-[175px] w-full mt-2 border-b-[1px] border-b-[#ABABAB52]">
      <div className="flex flex-col space-y-2 space-x-0 md:flex-row md:space-x-4 md:space-y-0 items-center">
        <div className="w-full flex items-center justify-between space-x-2">
          {props.status ? (
            <HiMiniCheckBadge className="h-[20px] w-[20px] md:h-[25px] md:w-[25px] text-[#1BA74C]" />
          ) : (
            <MdOutlinePending className="h-[20px] w-[20px] md:h-[25px] md:w-[25px] text-[#D86D6A]" />
          )}
        ...
        <div className="space-y-2 sm:space-y-3">
          <div className="w-full flex flex-none space-x-1">
            <div className="py-2 px-2.5 rounded-lg space-x-1 flex items-center justify-center bg-[#2D3A4B]">
              <IoMdCalendar className="h-[11px] w-[11px] md:h-xs md:text-sm md:w-[14px] text-[#FFFFFF]" />
              <h1 className="text-[#FFFFFF] text-[10px] md:text-[11px] font-medium">
                Day 1
              </h1>
            </div>
            <div className="flex space-x-2 items-center justify-center h-[33px] w-[85px]">
              ...
              <h1 className="text-[10px] md:text-[12px] text-[#2D3A4B] font-medium">
                301
              </h1>
            </div>
          </div>
          <h1 className="w-full flex flex-none text-[#2D3A4B] text-sm md:text-md font-medium">
          ...
          <div className="w-full flex flex-wrap md:flex-nowrap md:flex-none md:space-x-4">
            <div className="space-x-1 mr-3 md:mr-0 mb-2 flex items-center justify-center flex-none">
              <PiVideo className="text-[#4A90E2] h-[20px] w-[20px] md:h-[22px] md:w-[22px]" />
              <h1 className="text-[#4A90E2] text-xs md:text-sm font-medium underline">
                Watch class
              </h1>
            </div>
            <div className="space-x-1 mr-3 md:mr-0 mb-2 flex items-center justify-center flex-none">
              <MdOutlineAssignment className="text-[#9747FF] h-[20px] w-[20px]" />
              <h1 className="text-[#9B51E0] text-xs md:text-sm font-medium underline">
                1 assignment
              </h1>
            </div>
            <div className="space-x-1 mr-3 md:mr-0 mb-2 flex items-center justify-center flex-none">
      ...
      <div className="space-y-2 flex-none flex flex-col items-start justify-start md:items-end md:justify-end">
        <div className="flex space-x-2 justify-center items-center">
          <IoMdCalendar className="h-[20px] w-[20px] md:h-[22px] md:w-[22px] text-[#2D3A4B]" />
          <h1 className="text-xs md:text-sm text-[#2D3A4B] font-medium">
            23rd Nov, 2024 | 9:00am GMT
          </h1>
        </div>
        <h1 className="text-xs md:text-sm text-[#2D3A4B] font-light">
          {" "}
          <span className="text-[#5801A9] font-semibold">Lead tutor</span> - @
          vladamirocks@gmail.com
        </h1>
        <h1 className="text-xs md:text-sm font-medium text-[#8176766E]">
          Meeting - https://us05web.zoom.us/j/...
        </h1>
        {props.status ? (
          <div className="flex space-x-2 items-center">
            <HiMiniCheckBadge className="h-[20px] w-[20px] md:h-[22px] md:w-[22px] text-[#1BA74C]" />

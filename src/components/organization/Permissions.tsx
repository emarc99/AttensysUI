      ...
      <table className="w-full border-collapse">
        <thead className=''>
          <tr className="border-b border-gray-300 h-[40px]">
            ...
            <th className="text-left px-4 text-[14px] leading-[22px] font-bold text-[#333333]"> Roles</th>
            <th className="text-left px-4 text-[14px] leading-[22px] font-bold text-[#333333]">Actions</th>
          </tr>
        </thead>
        <tbody>
    {permisiondata.map((data, index)=>{
          return  <tr key={index} className="border-b border-gray-300 h-[70px]">
            ...
            <td className="py-3 px-4 flex space-x-1 items-center h-[70px]">
                ...
                <div className='text-[12px] leading-[22px] font-medium text-[#FFFFFF] h-[28px] w-[58px] bg-[#4A90E2] rounded-lg flex items-center justify-center'>Owner</div>

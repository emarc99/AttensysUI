  ...
  return (
    <div className='h-[120px] pt-3 clg:h-[80px] lg:h-[70px] lclg:h-[60px] flex flex-col lg:flex-row justify-around w-[90%] mx-auto items-start lg:items-center lg:pt-10'>
      <div className="lg:w-full sm:w[90%]">
        <div className='flex min-w-max lg:space-x-4 space-x-3 items-center lg:px-4'>
          <div onClick={handleDiscover} className='flex space-x-3 items-center cursor-pointer'>
            ...
            <h1 className='text-[14px] lg:text-[16px] font-medium text-[#333333]'>Discover</h1>
          </div>
          ...
          <div className='flex space-x-3 items-center cursor-pointer' onClick={handlerouting}>
            ...
            <h1 className='text-[14px] lg:text-[16px] font-medium text-[#333333]'>My Events</h1>
          </div>
          <div className="w-[1px] h-[24px] bg-[#9B51E0]"></div>
          <div className='flex space-x-3 items-center cursor-pointer'>
            <h1 className='text-[14px] lg:text-[16px] font-medium text-[#333333]'>{props.eventsname}</h1>
          </div>
        </div>
      </div>
      ...
      <div className='space-x-3 md:space-x-6 flex items-center'>
        ...
        <Button onClick={handleEventPage} className="justify-center flex rounded-lg bg-[#2D3A4B] py-2 px-4 lg:h-[42x] items-center lg:w-[180px] text-sm text-[#FFFFFF] data-[hover]:bg-sky-500 data-[active]:bg-sky-700">

...
const Timesection = () => {
  return (
    <div className='h-[305px] w-[87%] mx-auto mt-6'>
        ...
        <h1 className='text-[24px] text-[#FFFFFF] font-bold leading-[39px]'>Discover Events</h1>
        <p className='text-[#FFFFFF] text-[16px] font-light leading-[22px]'>Each week, we highlight some of our top events in cities like Lagos and the UAE.<br/>You can also explore fantastic community-curated calendars.</p>
        </div>

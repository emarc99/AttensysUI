  ...
  const renderHeader = () => {
    switch (section) {
      case "basic-info":
        return (
          <>
            <h1 className="text-[18px] font-bold text-[#5801A9] leading-[22px]">
              Getting you ready in 5 easy steps
            </h1>
            <div className="flex space-x-4 justify-center items-center">
              <div
                className={`border-[1px] rounded-full border-[#9B51E0]  bg-[#9B51E0] text-[#FFFFFF] h-[38px] w-[38px] flex items-center justify-center`}
              >
                1
              </div>
              <div className="h-[1px] w-[54px] border-[1px] border-[#5801A9]"></div>
              <div
                className={`border-[1px] rounded-full border-[#9B51E0] h-[38px] w-[38px] flex items-center justify-center`}
              >
                2
              </div>
              <div className="h-[1px] w-[54px] border-[1px] border-[#5801A9]"></div>
        ...
        return (
          <>
            ...
            <div className="flex space-x-4 justify-center items-center">
              ...
              <div className="h-[1px] w-[54px] border-[1px] border-[#5801A9]"></div>
              <div
                className={`border-[1px] rounded-full border-[#9B51E0] h-[38px] w-[38px] bg-[#9B51E0] text-[#FFFFFF] flex items-center justify-center`}
              >
                2
              </div>
              <div className="h-[1px] w-[54px] border-[1px] border-[#5801A9]"></div>
      ...
      case "admin-info":
        return (
          <>
            ...
            <p className="w-[580px] text-center text-[14px] font-light leading-[20px]">
              As an organization admin{" "}
              <span className="text-[#4A90E2]">
                you reserve full access to add instructors, issue certificates,
                access control and sole management rights to your organization.
              </span>{" "}
              This information help us verify it&apos;s you whenever we suspect
